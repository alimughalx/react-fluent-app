...
class Calendar extends React.Component<AuthComponentProps, CalendarState> {
  ...
  async componentDidUpdate() {
    if (this.props.user && !this.state.eventsLoaded) {
      try {
        ...
        // 07:00:00Z
        var startOfWeek = moment.tz(ianaTimeZone!.valueOf()).startOf('week').utc(true);
  ...
  render() {
    ...
    return (
      <div>
        <MetaInfo title={RoutesConfig.Calendar.metaInfo.title} description={RoutesConfig.Calendar.metaInfo.title}></MetaInfo>
        <div className="mb-3">
